package com.example.al9ani.controllers.front.commentaire;


import com.example.al9ani.controllers.front.MainWindowController;
...
import com.example.al9ani.services.CommentaireService;
import com.example.al9ani.services.PostService;
import com.example.al9ani.utils.AlertUtils;
...
public class ManageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for (User user : CommentaireService.getInstance().getAllUsers()) {
            userCB.getItems().add(user);
        }

        postCB.setValue(com.example.al9ani.controllers.front.post.ShowAllController.currentPost);
